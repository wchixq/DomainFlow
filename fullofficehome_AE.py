...
def train(args):
    ...
    exp_name = 'AE%.2f_seed%d_' % (w_recon,seed) + source[0] + '2' + target[0]
    ...
    for epoch in range(1, num_epochs+1):
        ...
        log_with_print(log_writer, 'epoch%03d: l_ce:%f l_recon:%f test_acc:%.2f/%.2f in%.1fmin' % (
            epoch, l_ce_val, l_recon_val,acc_ep, best_tgt_acc, time_taken))
        log_writer.flush()
